...
<tr><td>{|Reserviersperre|}:</td><td>[NICHT_RESERVIEREN][MSGNICHT_RESERVIEREN]</td></tr>
<tr><td>{|Reservierungs Datum|}:</td><td>[RESERVATIONDATE][MSGRESERVATIONDATE]</td></tr>
<tr><td>[VORWUNSCHLAGER]Lager:[NACHWUNSCHLAGER]<br></td><td>[VORWUNSCHLAGER][STANDARDLAGER][MSGSTANDARDLAGER][NACHWUNSCHLAGER]</td></tr>
